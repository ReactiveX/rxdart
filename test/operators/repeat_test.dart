...
void main() {
  test('rx.Observable.repeat', () async {
    ...
    rx.observable(_getStream()).repeat(3).listen(expectAsync1((int result) {
  ...
  test('rx.Observable.repeat.asBroadcastStream', () async {
    Stream<int> observable =
        rx.observable(_getStream().asBroadcastStream()).repeat(3);
  ...
  test('rx.Observable.repeat.error.shouldThrow', () async {
    Stream<num> observableWithError =
        rx.observable(getErroneousStream()).repeat(3);
