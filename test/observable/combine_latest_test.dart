...
void main() {
  ...
  test('rx.Observable.combineLatest.error.shouldThrow.A', () async {
    Stream<String> observableWithError = new rx.Observable.combineLatest(_getStreams(),
  ...
  test('rx.Observable.combineLatest.error.shouldThrow.B', () async {
    Stream<String> observableWithError = new rx.Observable.combineLatest(_getStreams()..add(_getErroneousStream()),
